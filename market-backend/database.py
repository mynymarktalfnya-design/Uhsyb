...
def init_indexes():
    ...
    try:
        ...
        db[C.products].create_index([("deleted_at", ASCENDING), ("is_active", ASCENDING), ("name", ASCENDING)], name="products_active_name")
        ...
        db[C.customers].create_index([("full_name", ASCENDING)], name="customers_full_name")
        db[C.customers].create_index([("deleted_at", ASCENDING), ("is_active", ASCENDING), ("full_name", ASCENDING)], name="customers_active_name")
        db[C.suppliers].create_index([("name", ASCENDING)])
        db[C.suppliers].create_index([("phone", ASCENDING)], name="suppliers_phone")
        db[C.suppliers].create_index([("deleted_at", ASCENDING), ("is_active", ASCENDING), ("name", ASCENDING)], name="suppliers_active_name")
        ...
        db[C.sales].create_index([("deleted_at", ASCENDING), ("created_at", DESCENDING)], name="sales_active_date")
        db[C.sales].create_index([("customer_id", ASCENDING), ("created_at", DESCENDING)], name="sales_customer_date")
        db[C.sales].create_index([("cashier_id", ASCENDING), ("created_at", DESCENDING)], name="sales_cashier_date")
        db[C.sales].create_index([("shift_id", ASCENDING)], name="sales_shift")
        db[C.sale_items].create_index([("sale_id", ASCENDING)])
        db[C.sale_items].create_index([("product_id", ASCENDING)], name="sale_items_product")
        db[C.sale_payments].create_index([("sale_id", ASCENDING)], name="sale_payments_sale")
        db[C.purchases].create_index([("supplier_id", ASCENDING), ("deleted_at", ASCENDING), ("created_at", DESCENDING)], name="purchases_supplier_date")
        db[C.purchases].create_index([("deleted_at", ASCENDING), ("created_at", DESCENDING)], name="purchases_active_date")
        db[C.purchases].create_index([("supplier_invoice_no", ASCENDING), ("created_at", DESCENDING)], name="purchases_supplier_invoice_date")
        db[C.purchase_items].create_index([("purchase_id", ASCENDING)], name="purchase_items_purchase")
        db[C.purchase_items].create_index([("product_id", ASCENDING)], name="purchase_items_product")
        db[C.supplier_payments].create_index([("supplier_id", ASCENDING), ("created_at", DESCENDING)], name="supplier_payments_supplier_date")
        db[C.supplier_returns].create_index([("supplier_id", ASCENDING), ("created_at", DESCENDING)], name="supplier_returns_supplier_date")
        db[C.customer_payments].create_index([("customer_id", ASCENDING), ("created_at", DESCENDING)], name="customer_payments_customer_date")
        db[C.inventory_movements].create_index([("product_id", ASCENDING), ("created_at", DESCENDING)], name="inventory_product_date")
        ...
        db[C.idempotency_keys].create_index([("created_at", DESCENDING)], name="idempotency_created")
        ...
        db[C.sync_queue].create_index([("status", ASCENDING), ("created_at", ASCENDING)], name="sync_queue_status_date")
